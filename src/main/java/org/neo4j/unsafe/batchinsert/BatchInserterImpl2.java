...
public class BatchInserterImpl2 implements BatchInserter
{
    ...
    BatchInserterImpl2( String storeDir )
    {
        ...
        Map<String,String> stringParams )
    {
        ...
        StoreFactory sf = new StoreFactory( config,idGeneratorFactory, null, fileSystem, StringLogger.DEV_NULL, null);
