...
import org.neo4j.kernel.impl.coreapi.schema.*;
...
import org.neo4j.kernel.impl.nioneo.xa.*;
...
public class BatchInserterImpl implements BatchInserter
{
    ...
    private Iterator<PropertyBlock> propertiesIterator( Map<String, Object> properties )
    {
        ...
        return new IteratorWrapper<PropertyBlock, Entry<String,Object>>( properties.entrySet().iterator() )
        {
            @Override
